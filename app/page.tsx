    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#25282A] to-[#25282A] p-4">
      <Card className="w-full max-w-md mx-auto">
        <CardHeader className="text-center space-y-4">
          <div className="w-80 h-24 bg-white rounded-lg flex items-center justify-center mx-auto overflow-hidden p-3 shadow-sm">
        ...
        >
          <SidebarHeader>
            <div className="flex items-center space-x-3 w-full p-2">
              <div className="w-24 h-12 bg-white rounded-lg flex items-center justify-center overflow-hidden p-2 flex-shrink-0 shadow-sm">
                <img
